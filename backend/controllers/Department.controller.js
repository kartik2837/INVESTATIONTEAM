...
exports.create = async (req, res) => {
  try {
    ...
    const detailExist = await Department.findOne({ name });
    if (detailExist) {
...
exports.update = async (req, res) => {
  try {
    ...
    let updateDetail = await Department.findById(updateId);
    if (!updateDetail)
...
exports.getAllData = async (req, res) => {
  try {
    ...
    const totalData = await Department.countDocuments({});
...
exports.bulkDelete = async (req, res) => {
  try {
    ...
    const bulkDeleteAll = await Department.find({ _id: { $in: delId } });
    ...
    await Department.deleteMany({ _id: { $in: delId } });
